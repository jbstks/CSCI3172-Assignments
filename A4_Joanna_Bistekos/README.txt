+-----------------------------------------------------------------------------+
| README.TXT --- JOANNA BISTEKOS (B00710704)                                  |
+-----------------------------------------------------------------------------+
...
[1] Hayani, S. (2018). Learn how to create your first Angular app in 20 minutes.
    Retrieved from
    https://medium.freecodecamp.org/learn-how-to-create-your-first-angular-app-in-20-min-146201d9b5a7

[2] Van de Moere, J. (2018). Understanding Component Architecture: Refactoring
